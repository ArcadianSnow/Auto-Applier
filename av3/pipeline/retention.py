...
via :func:`av3.db.engine.tx` so a crash mid-delete rolls back.
...
from av3.db.engine import backup_db, rotate_backups, tx
from av3.domain.state import EPHEMERAL_STATES
from av3.telemetry import EventSink, get_sink
