...
from av3.config.settings import ScoringWeights, Settings
from av3.db.repositories import JobRepo, ScoreRepo
from av3.domain.models import Job, JobScore
...
#: The canonical axis order. Used both for prompt schema (in :mod:`av3.llm.prompts`)
