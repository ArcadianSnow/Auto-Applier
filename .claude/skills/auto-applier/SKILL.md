...
| **Field coverage ROUND 2 (PLANNED 2026-06-24, handoff)** — fill the remaining live misses per owner decisions: new fact-bank `languages` (default English) + `availability`/notice (default 2 weeks) + salary + nationality, all via ONBOARDING; new classifiers LANGUAGES/CURRENT_COMPANY/AVAILABILITY; the Ashby id-less Location combobox FILL. Round 1 live-verified 2026-06-24 (Lever urls[LinkedIn]+work-auth+location LAND; Ashby work-auth+sponsorship+phone LAND). | `research/field-coverage-round2.md` |
