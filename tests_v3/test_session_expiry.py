...
from av3.pipeline.apply_worker import ApplyWorker, DriverEntry
from av3.resume.factbank import Contact, FactBank, WorkEntry
from av3.sources.browser.apply_base import check_auth_wall
from av3.sources.browser.detect import detect_login_wall
...
class _RecordingDriver:
    ...
    async def prepare(self, page, listing, applicant, resume_path, *,
        ...
        from av3.sources.browser.apply_base import ApplyOutcome
