...
from av3.doctor import Status, check_relay_reachable
from av3.telemetry import EventSink, reset_sink
from av3.telemetry.client import DrainResult, MirrorClient, _ingest_url
...
def test_mirror_drain_happy_path(monkeypatch, data_dir):
    ...
    from av3.telemetry import attach_mirror_from_settings
