...
from av3.domain.models import Job, utcnow_iso
from av3.domain.state import JobState
from av3.db.repositories import JobRepo
from av3.sources.health import mark_auth_required, mark_healthy, reset_health
from av3.web import SchedulerService, WebState, create_app
from av3.web.service import sync_factory


# --------------------------------------------------------------- stub Scheduler

class _StubScheduler:
    """Drop-in for ``av3.pipeline.Scheduler`` that supports cancellation and
