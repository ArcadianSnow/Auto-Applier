...
def _patch(monkeypatch, *, summary: ApplyRunSummary | None = None) -> None:
    ...
    monkeypatch.setattr("auto_applier.pipeline.ApplyWorker", _RecordingWorker)
    monkeypatch.setattr("auto_applier.sources.browser.session.BrowserSession", _StubSession)
