...
:class:`auto_applier.web.service.SchedulerService` (when provided) plus the (3/M)
...
from auto_applier.web.routes import api_router, pages_router
...
class ControlWatcher(Protocol):
    ...
    Both :class:`auto_applier.web.hotkey.HotkeyWatcher` and
    :class:`auto_applier.web.idle.IdleWatcher` satisfy this — they each spawn a
