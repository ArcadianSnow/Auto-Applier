...
Run from the GUI's onboarding step, or on demand:
    ...
    >>> from auto_applier.db.engine import open_db                      # doctest: +SKIP
    >>> from auto_applier.db.repositories import AnswerRepo             # doctest: +SKIP
    >>> from auto_applier.llm.embed import OllamaEmbeddings             # doctest: +SKIP
    >>> from auto_applier.resume.seed_answers import seed_from_v2_file  # doctest: +SKIP
